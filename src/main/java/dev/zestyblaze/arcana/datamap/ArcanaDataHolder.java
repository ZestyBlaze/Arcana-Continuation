...
public record ArcanaDataHolder(List<Holder<State>> states, List<Structure> structures) {
    public static final Codec<ArcanaDataHolder> CODEC = RecordCodecBuilder.create(func -> func.group(
            ...
            Structure.CODEC.listOf().optionalFieldOf("structures", new ArrayList<>()).forGetter(ArcanaDataHolder::structures)
